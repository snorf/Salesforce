...
class Application {
     ...
     **************************************************************************************/
    function createPlatformEventRecord(data, cb = null) {
    ...
    function streamReadingsHandler(reading) {
        ...
        createPlatformEventRecord(reading, createPlatformEventRecordResHandler);
    }
    ...
    /***************************************************************************************
     * createPlatformEventRecordResHandler
     * Returns: null
     * Parameters:
     *      err : string/null - error message
     *      respData : table - response table
     **************************************************************************************/
    function createPlatformEventRecordResHandler(err, respData) {
        if (err) {
            server.error(http.jsonencode(err));
            return;
        }
        ...
        if ("success" in respData) {
            server.log("Platform Event created: " + respData.success);
        }
    }    
...
const OBJ_API_NAME = "Fridge_Reading__e";
